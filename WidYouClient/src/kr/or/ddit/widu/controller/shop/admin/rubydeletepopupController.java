...
public class rubydeletepopupController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		del_btn.setOnAction(event -> {
			...
			params.put("rubby_id", String.valueOf(shopDataManage.itemInfo_1.getRubby_id()));
			
			try {
				int chk = service.rubydeleteItem(params);
